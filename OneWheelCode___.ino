...
Servo HubMotor; //declaring that "hub motor" is going to refrence the motor and then declares it 


//Used some example code then converted it to work with onewheel

/*MPU-6050 gives you 16 bits data so you have to create some 16int constants
 * to store the data for accelerations and gyro*/

//DATA Wire for vesc is pin 3
//
...
void setup() {
  ...
  HubMotor.writeMicroseconds(1000);
...
pwmRight = throttle - PID;  //1500 (dead stop) +- 1000
...
//Left
//if(pwmLeft < 1500)  //for the left side but is not nessasary (for drone)
//{
 // pwmLeft= 1000;
//}
//if(pwmLeft > 2000)
...
//HubMotor.writeMicroseconds(pwmLeft);
HubMotor.writeMicroseconds(pwmRight);
previous_error = error; //Remember to store the previous error.

}//end of loop void

//This code was taken from electronoobs then made to work with a one wheel by Max Goldenson
